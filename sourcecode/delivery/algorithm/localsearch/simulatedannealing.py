...
class SimulatedAnnealing(LocalSearch):
    def __init__(self, data, max_iterations=5000, iteration_search=50, max_time=30, save_results=False, temperature_schedule=0.9, initial_temperature=1000):
        super().__init__(data, max_iterations, iteration_search, max_time, save_results)
